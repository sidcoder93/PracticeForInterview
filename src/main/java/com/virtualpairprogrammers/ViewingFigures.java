...
public class ViewingFigures 
{
	...
	public static void main(String[] args)
	{
		...
		JavaPairRDD<Integer, Integer> chapterCount = chapterData.mapToPair(row -> new Tuple2<Integer, Integer>(row._2, 1))
		...
		//join data from chapterData abd viewData on chapterID
		//flip data to bring chapter id
		...
		//step3 - don't need chapter Ids, setting up reduce
		...
		// Step 4 - Reduce step 3

		JavaPairRDD<Tuple2<Integer, Integer>, Long> step4 = step3.reduceByKey((value1, value2) -> value1 + value2);

		//step 5 - drop userId

		JavaPairRDD<Integer, Long> step5 = step4.mapToPair(row -> {
			Integer userId = row._1._2;
			Long view = row._2;

			return new Tuple2<Integer, Long>(userId, view);
		});
